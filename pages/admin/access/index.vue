...
<script lang="ts" setup>
  ...
  const canViewAdmins = computed(
    () => adminAuthStore.hasRole("super-admin") || adminAuthStore.hasPermission("view-admins")
  );
  const canViewRoles = computed(
    () => adminAuthStore.hasRole("super-admin") || adminAuthStore.hasPermission("view-roles")
  );
  const canViewPermissions = computed(
    () => adminAuthStore.hasRole("super-admin") || adminAuthStore.hasPermission("view-permissions")
  );
