  ...
  <div class="settings-page">
    <div class="settings-page__header">
      <div>
        ...
        <p>
          {{ resolveText("admin.settings.subtitle", "Системные настройки, резервные копии и мониторинг сервера.") }}
        </p>
      </div>
    </div>
...
<script lang="ts" setup>
  ...
  import LandingSeoSettings from "./components/LandingSeoSettings.vue";
    ...
    return [
      {
        ...
        description: resolveText(
          "admin.settings.tabsDescription.general",
          "Резервные копии базы данных и состояние хранения."
        ),
        icon: "pi pi-database",
        component: General,
      },
      ...
      {
        id: "landing-seo",
        label: resolveText("admin.settings.tabs.landingSeo", "SEO лендинга"),
        description: resolveText(
          "admin.settings.tabsDescription.landingSeo",
          "SSR meta-теги, canonical, robots, sitemap и social preview для страниц лендинга."
        ),
        icon: "pi pi-search",
        component: LandingSeoSettings,
      },
      {
        id: "faq",
