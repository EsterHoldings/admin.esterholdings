<template>
  <div ref="wrapper" class="relative">
    <button
        ref="body"
        type="button"
        class="select outline-none inline-flex h-10 w-full items-center justify-start gap-2 rounded-[8px] border bg-[var(--color-stroke-ui-dark)] px-5 text-[var(--color-ui-text)] transition
